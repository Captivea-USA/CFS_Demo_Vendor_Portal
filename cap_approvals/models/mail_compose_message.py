...
<div id='buttons_acknowledgement'>
    <br>
    <a href="%s/acknowledgement/acknowledged/%s/%s" class="btn btn-primary" target="_blank">Yes</a>
    <a href="%s/acknowledgement/denied/%s/%s" class="btn btn-primary" target="_blank">No</a>
</div>
"""
