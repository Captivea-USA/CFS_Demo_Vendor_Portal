...
class ApprovalProductLine(models.Model):
    ...
    wh_type = fields.Selection(related='warehouse_id.wh_type')
    ...
    cap_warehouse = fields.Many2one('stock.warehouse',related='approval_request_id.cap_warehouse')
    ...
    cap_need_date = fields.Date(string="Need Date", related='approval_request_id.cap_need_date')
    ...
    def _domain_products(self):
        ...
        for rec in self:
            ...
            if not rec.cap_warehouse and rec.approval_request_id.cap_ship_to != 'request_new_address':
